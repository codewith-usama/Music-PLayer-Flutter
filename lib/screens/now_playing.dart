  ...
  void listenToSongIndex() {
    ...
    widget.audioPlayer.currentIndexStream.listen((event) {
      setState(() {
        if (event != null) {
          currentIndex = event;
          _isFavouriteSong = widget.songModelList[currentIndex].isFavorite;
        }
        context
            .read<SongModelProvider>()
            .setId(widget.songModelList[currentIndex].id);
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            final songProvider =
                                context.read<SongModelProvider>();
                            final currentSong = songProvider.getCurrentSong();
                            if (currentSong != null) {
                              songProvider.toggleFavorite(currentSong.id);
                            }
                          },
                          icon: _isFavouriteSong == false
